...
class DataPreprocessor:
    ...
    def execute_pipeline(self, nc_file1, nc_file2):
        ...
        normalized_anomalies1 = self.min_max_normalize(anomalies1)
        normalized_anomalies2 = self.min_max_normalize(anomalies2)
        

        # Concatenate anomalies along the appropriate axis (assuming anomalies have the same shape)
        concatenated_anomalies = np.concatenate((normalized_anomalies1, normalized_anomalies2), axis=2)
